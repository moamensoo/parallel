...
private void fillCombo()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(department, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(flight, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String erole=role.getText();
        int esal=Integer.parseInt(salary.getText());
        d.updateEmployeeByE_Id(ssnV, dep, ename, erole, esal);
        ID.setText("");
        department.setText("");
        name.setText("");
        salary.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int ssnV= Integer.parseInt(comboSSN.getSelectedItem().toString());
        DBAccess d= new DBAccess();
        employee p= d.getEmployeeByE_Id(ssnV);
        if(p!=null){
            ID.setText(p.getE_id()+"");
            department.setText(p.getDepartment());
            name.setText(p.getE_name());
            role.setText(p.getRole());
            username.setText(p.getUsername());
            date.setText(p.getDate());
            salary.setText(p.getsalary()+"");
            flight.setText(p.getflightNumber()+"");
        }
