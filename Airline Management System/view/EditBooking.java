...
private void fillCombo()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(27, 27, 27)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(seat, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                                    .addComponent(flight))))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(105, 105, 105)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DBAccess d= new DBAccess();
        d.deleteBookingByBookingId(ssnV);
        bId.setText("");
        seat.setText("");
        Class.setText("");
        date.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int ssnV= Integer.parseInt(comboSSN.getSelectedItem().toString());
        DBAccess d= new DBAccess();
        int pnameV=Integer.parseInt(seat.getText());
        String phoneV=Class.getText();
        String ageV=date.getText();
        d.updateBookingByBookingId(ssnV, pnameV, ageV, phoneV);
        bId.setText("");
        seat.setText("");
        Class.setText("");
        date.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int ssnV= Integer.parseInt(comboSSN.getSelectedItem().toString());
        DBAccess d= new DBAccess();
        booking p= d.getBookingByBookingId(ssnV);
        if(p!=null){
            bId.setText(p.getBookingId()+"");
            seat.setText(p.getSeatNo()+"");
            Class.setText(p.getclass());
            date.setText(p.getBookingDate());
            flight.setText(p.getFlight_Number()+"");
            pass.setText(p.getPassportNumber()+"");
        }
