 ...
 * @author NAJI
 */
public class EditBaggage extends javax.swing.JFrame {

    /**
     * Creates new form EditBaggage
     */
    public EditBaggage() {
        initComponents();
        fillCombo();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage baggage");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DBAccess d= new DBAccess();
        baggage p= d.getBaggageByBaggageId(ssnV);
        if(p!=null){
            ssn.setText(p.getBaggageId()+"");
            name.setText(p.getWeight()+"");
            status.setText(p.getPassportNumber()+"");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int ssnV= Integer.parseInt(comboSSN.getSelectedItem().toString());
        DBAccess d= new DBAccess();
        d.deleteBaggageByBaggageId(ssnV);
        ssn.setText("");
        name.setText("");
        status.setText("");
        fillCombo();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int ssnV= Integer.parseInt(comboSSN.getSelectedItem().toString());
        DBAccess d= new DBAccess();
        double pnameV=Double.parseDouble(name.getText());
        d.updateBaggageByBaggageId(ssnV, pnameV);
        ssn.setText("");
        name.setText("");
        status.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBaggage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditBaggage().setVisible(true);
            }
        });
    }
