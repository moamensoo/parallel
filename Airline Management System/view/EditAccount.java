...
public class EditAccount extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(20, 20, 20)
                                .addComponent(passnum, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DBAccess d= new DBAccess();
        d.deleteAccountByUsername(ssnV);
        username.setText("");
        pass.setText("");
        email.setText("");
        permissions.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String ssnV= comboSSN.getSelectedItem().toString();
        DBAccess d= new DBAccess();
        String pnameV=permissions.getText();
        d.updateAccountByUsername(ssnV, pnameV);
        username.setText("");
        pass.setText("");
        email.setText("");
        permissions.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String ssnV= comboSSN.getSelectedItem().toString();
        DBAccess d= new DBAccess();
        account p= d.getAccountByUsername(ssnV);
        if(p!=null){
            username.setText(p.getUsername());
            pass.setText(p.getPassword());
            email.setText(p.getEmail());
            permissions.setText(p.getPermissions());
            pass.setText(p.getPassword());
            passnum.setText(p.getPassportNumber()+"");
        }
